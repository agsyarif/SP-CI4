...
<head>
    ...
    <title>Praktek 7 | Modular pada CodeIgniter 4</title>
...
<body>
    ...
    <div class="wrapper overlay-sidebar">
        <div class="main-header">
            <div class="logo-header" style="background-color: blue;" data-backgroud-color="blue2">
                <a href="#" class="logo">
            ...
            <nav class="navbar navbar-header navbar-expand-lg" style="background-color: blue;" data-backgroud-color="blue2"></nav>
        </div>
